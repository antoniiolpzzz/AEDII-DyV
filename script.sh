...
echo "¿Qué generador de casos desea ejecutar? (0, 1, 2)"
echo
echo "  ·0 - Usar una caso de prueba previamente generado."
echo "  ·1 - Generador de casos (n casos de tamaño de cadena aleatorio entre 10^4 y 10^6)."
echo "  ·2 - Generador de casos incremental (100 casos de tamaño 10^4 hasta 10^6, con incrementos de 10^4 por caso)."
echo
